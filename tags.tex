...
\ifthenelse{\equal{#2}{yellow}\OR\equal{#2}{cream}\OR\equal{#2}{clear}\OR\equal{#2}{pink}}
...
%%%%%%  FULL %%%%%%%
%       If you want to see dotted lines around the whole tag, uncomment line 184 and comment out lines 189-197
%		\draw[-,dotted] (.25in,0) -- ++(1.7in,0) -- ++(.25in,-.5in) -- ++(0in,-3.25in) -- ++(-.25in,-.5in) -- ++(-1.7in,0in) -- ++(-.25in,.5in) -- ++(0in,3.25in) -- ++(.25in,.5in);


%%%%%% PARTIAL %%%%%
%   If you want to have dotted lines only outside the tag (to be cut by a paper cutter) so as to avoid dots on your tag, uncomment lines 189-197 and comment out line 184
